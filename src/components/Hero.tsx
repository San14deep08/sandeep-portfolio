  ...
  return (
    <section className="relative overflow-hidden pb-24 pt-28 md:pb-32 md:pt-40">
      ...
      <div className="container-x relative">
        ...
        {/* Power headline — line 1 white, line 2 mint */}
        <h1 className="font-display text-5xl font-extrabold leading-[1.08] tracking-tight md:text-7xl lg:text-[82px]">
          <span className="text-fg">{profile.headline.leading}</span>
          <br />
          <span className="text-mint">{profile.headline.trailing}</span>
        </h1>
